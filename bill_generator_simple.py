"""
Bill Generator Tool - SIMPLE VERSION
...
class BillGeneratorTool:
    def __init__(self):
        """Initialize Bill Generator tool"""
        self.root = tk.Tk()
    ...
    def create_interface(self):
        ...
        info_label = tk.Label(
            main_frame,
            text="Bill Generator is available online",
            font=("Arial", 12),
            fg="green"
        )
        ...
        redirect_btn = tk.Button(
            main_frame, 
            text="Open Bill Generator Online", 
