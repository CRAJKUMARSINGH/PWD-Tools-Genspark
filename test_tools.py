#!/usr/bin/env python3
"""
Test script for PWD Tools - Tests each tool 5 times programmatically
"""
...
def test_emd_refund(test_number):
    ...
    bank_name = random.choice(["SBI", "PNB", "BOB", "HDFC", "ICICI"])
    guarantee_number = f"GN-{random.randint(100000, 999999)}"
...
def test_deductions_table(test_number):
    ...
    work_description = f"Work description for test #{test_number}"
