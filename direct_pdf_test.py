...
def test_pdf_generation():
    ...
    try:
        ...
        # Sample data
        payee_name = 'Direct Test User'
        amount = 25000.00
        work_description = 'Direct Test Work Description'
        ...
        filename = f"EMD_Refund_Direct_Test_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf"
...
if __name__ == "__main__":
    ...
    if success:
        print("\n✅ Direct PDF generation test PASSED!")
    else:
        print("\n❌ Direct PDF generation test FAILED!")